...
public class MovimentoGhost extends JPanel{
    private Ghost[] fantasma = new Ghost[4];//instancia os 4 fantasmas
    private Color[] corDoFantasma = {Color.RED, Color.PINK, Color.GREEN, Color.ORANGE};
    private int[] direcao = {1, 2, 3, 4};//direita, esquerda, cima, baixo
    private Timer timer, timer1;
    private int contador=0;
    private boolean continua = true;

    //função que verifica se o fantasma está na mesma posição do pacman
